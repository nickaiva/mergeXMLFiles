...
public class MergeXMLFilesFrame_AboutBoxPanel1 extends JPanel 
{
  ...
  public MergeXMLFilesFrame_AboutBoxPanel1()
  {
    try
    {
      jbInit();
  ...
  private void jbInit() throws Exception
  {
    ...
    labelTitle.setText("MergeXML Files ");
    labelAuthor.setText("Nick Aivaliotis");
    labelCopyright.setText("Copyright 2007");
    labelCompany.setText("http://nickaiva.blogspot.com");
